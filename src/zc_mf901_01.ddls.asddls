...
@EndUserText.label: 'Projection View for ZI_MF901_01'
@Metadata.ignorePropagatedAnnotations: true
@Metadata.allowExtensions: true
define root view entity ZC_MF901_01
  provider contract transactional_query
  as projection on ZI_MF901_01
{
  key AttachmentUUID,
      ...
      /* Associations */
      _Item : redirected to composition child ZC_MF901_02
}
